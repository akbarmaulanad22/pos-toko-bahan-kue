...
@section('content')
    <section>
        <form class="row g-3" method="POST"
            action="{{ route('financial-trackers.update', ['financial_tracker' => $financial]) }}">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="description" name="description"
                    aria-describedby="descriptionFeedback" value="{{ old('description', $financial->description) }}"
                    required>
                @error('description')
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="amount" name="amount" aria-describedby="amountFeedback"
                    value="{{ old('amount', $financial->amount) }}" required>
                @error('amount')
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" id="type" name="type" aria-describedby="typeFeedback" required>
                    ...
                    <option value="INCOME" {{ old('type', $financial->type) == 'INCOME' ? 'selected' : '' }}>
                        Income
                    </option>
                    <option value="EXPENSE" {{ old('type', $financial->type) == 'EXPENSE' ? 'selected' : '' }}>
                        Expense
                    </option>
                </select>
                @error('type')
