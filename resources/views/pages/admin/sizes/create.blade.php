        ...
        <div class="row">
            <div class="col-lg-8">
                <main class="form-product">
                    <form method="POST" action="{{ route('sizes.store', ['product' => $product]) }}" enctype="multipart/form-data">
                        
                        @csrf

                        <div class="form-floating">
                            <input type="text" class="form-control rounded-top @error('size') is-invalid @enderror"
                                id="size" name="size" placeholder="size" value="{{ old('size') }}">
                        ...
                        <div class="form-floating">
                            <input type="number" class="form-control rounded-bottom  @error('stock') is-invalid @enderror"
                                id="stock" name="stock" placeholder="stock" value="{{ old('stock') }}">
